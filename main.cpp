...
class SingleLinkedList
{
  ...
  public:
    ...
    {
      Initialize<std::initializer_list<Type> &>(values);
    }
    ...
    {
      ConstIterator iter{};
      iter.node_ = const_cast<Node *>(&head_);
    ...
    Iterator InsertAfter(ConstIterator pos, const Type &value)
    {
      ...
      inserted.node_ = new Node(value, pos.node_->next_node);

      pos.node_->next_node = inserted.node_;
      ++size_;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept
    {
      ...
      auto deletable = pos.node_->next_node;
      auto returned = deletable->next_node;

      pos.node_->next_node = returned;
      --size_;
